...
type UserService interface {
	...
	FindById(ctx context.Context, id uuid.UUID) error
...
func (UserServiceImpl) FindAll(ctx context.Context) error {
	return nil
}

func (UserServiceImpl) FindById(ctx context.Context, id uuid.UUID) error {
	return nil
}
